...
<%
	...
	int friend_id=Integer.parseInt(id_string);
	String friend_account=null;
		 	...
		 	<div class="ui-grid-a ui-responsive">
		  	<div class="ui-block-a">
		  		<div class="ui-body ui-body-d" style="margin-left:85px;margin-top:20px;height:80px">
		 			<a width="30"  href="Friend_friendList.jsp" data-role="button" data-ajax="false" data-icon="Back" data-iconpos="notext"></a>	
	 	  		</div>
	 	  	</div>
			<div class="ui-block-b">
				<div class="ui-body ui-body-d" style="height:80px">
		 			<h1><%=friend_name%>的朋友圈</h1>
	 	 		</div>
	 	 	</div>
			</div>		
		</div>	
		...
		<div class="personPage_contentPanel">
			<%	
				...
				try{					
					...
					user_ps.setString(1,friend_account);					
					...
					for(int i = 0; i<pages; i++){
						out.println("<a href='Friend_friendPage.jsp?page="+(i+1)+"'>"+(i+1)+"</a>");
					}
				   //关闭数据库连接
					stat.close();				
				}
